...
const (
	...
	// 7 days
	ORDER_SIGNATURE_EXPIRATION_BUFFER_HOURS = 24 * 7
...
var (
	CONDITIONAL_TRANSFER_FIELD_BIT_LENGTHS = map[string]int{
		"asset_id":               250,
	...
	ORDER_FIELD_BIT_LENGTHS = map[string]int{
	...
	WITHDRAWAL_FIELD_BIT_LENGTHS = map[string]int{
		"asset_id":               250,
		"position_id":            64,
		"nonce":                  32,
		"quantums_amount":        64,
	...
	ORACLE_PRICE_FIELD_BIT_LENGTHS = map[string]int{
		"asset_name":              128,
		"oracle_name":             40,
		"price":                   120,
